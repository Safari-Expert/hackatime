...
Rails.application.configure do
  ...
  # Allow self-hosted deployments to select local disk or R2 through env configuration.
  storage_service = ENV.fetch(
    "ACTIVE_STORAGE_SERVICE",
    Rails.configuration.x.safari_expert_self_hosted ? "local" : "r2",
  )
